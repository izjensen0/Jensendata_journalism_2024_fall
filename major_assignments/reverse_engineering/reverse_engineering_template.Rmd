...
Moore <- Moore |> 
  mutate(state = str_trim(state)) #to get rid of the spaces because it was giving me trouble
...
#issue when i use space state i get a bigger number like too big and contribution amount does work rn

Moore |> 
  filter(state != "MD") |> 
  summarise(M_total = sum(`Contribution.Amount`, na.rm = TRUE))
#2398716
