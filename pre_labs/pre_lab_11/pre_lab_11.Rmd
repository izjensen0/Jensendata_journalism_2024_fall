...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **Answer** The columns have the same names as the chart from the website. The variables are all chr.
...
**Task** Run the following code in the gray-colored codeblock below to find the text inside <li> tags. Describe the output: **Answer** The output is all the text in the sheet it starts with \n tags. Then observation 21 to 40 are the committee names. Then there are more \n tags with the text at the bottom of the website.
...
### Task 11: Turn the contents of the <li> and <a> tags into a dataframe **Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer** This dataframe has all the text and the url or lack thereof attached to it. It isn't until the third page where we get to the actual committees and their urls. 
