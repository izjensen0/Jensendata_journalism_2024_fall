...
In the space below, write the data type for the "last_name" column and the "amount" columns (it's in light gray, offset by \< \>). Also offer your best guess as to what the "last_name" column and the "amount" column represent. **Answer**chr and dbl
last name is probably the donors last name
amount I assume is the amount of money that was donated
...
**Answer**Its a list of the amount of donations per day going from earliest to latest.
...
**Answer** This codeblock is the same info but organized by the amount of donations per day most to least instead of by dates. 
...
**Answer** It has the organization that the donations were made to, the amount the donation was, and the amount of contributions to the organization.
...
**Answer**Its the organizationts, the number of contributions, and the total amount from the contributions. It is organized by most to least amount of total money contributed.
...
**Answer**This one is organized by the number of contributions. Hogan for Maryland is the top result from maryland.
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **Answer** This time it is grouped by city and it is ordered from most to least total amount contributed.
