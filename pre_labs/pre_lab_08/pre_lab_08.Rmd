...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer** It has 24 rows and 18 columns.
...
**Answer** First I am creating a new column that has the difference between the number of unaffiliated voters in 2022 and 2024. Then I am creating a new dataframe that has just the top 10 counties (head(10)) in terms of increase in unaffiliated voters, it only has county and the difference and it is arranged from most to least.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I just see a white page with nothing on it. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It put the bars in order from least to most increase in unaffiliated voters. It also changed the title of the x access to say reorder.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** This put counties on the y axis instead of the x axis. Now the county with the most increase in unaffilated voters is at the top. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The background is lighter. It's pretty subtle.
...
**Task** Run the following code. **Answer** I ran the code. Got some warnings.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** This theme as a new bluish background. There are also no vertical lines that track from the counts.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It added a title and caption or source. It also changed the x and y axis titles. This makes much more sense and is more informative. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** It's a data frame with the total contributions for each date. All the dates are in 2022 from April to June.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** It's a line graph with the date on the x axis and the total contributions on the y axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** This mostly changes the x axis labels and adds weekly labels. The weekly labels are just a date that I assume begins that week. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** It's the same labels on the x axis but they are tilted so that they are spaced further apart and easier to read. 
