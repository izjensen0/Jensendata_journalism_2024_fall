...
**Answer** Copy the url of the graphic you published here. It will begin with <https://datawrapper.dwcdn.net/>. Don't copy the browser's current url. https://datawrapper.dwcdn.net/JX9Iz/1/ 
...
md_gov_county <-md_gov_county |>
  mutate(
    MoorePercentage = (Moore/ (Cox + Moore + Lashar + Wallace + Harding + `Write-ins`))*100
  )
...
It was the whole US map before with all the counties grayed out and now its just maryland with a bit of the bordering states in gray.
...
Now when you hover over the counties it gives the county name rather than numbers that mean little to anyone and it gives the percentage of the vote that went to Wes Moore.
...
https://datawrapper.dwcdn.net/4IKwW/1/ 
